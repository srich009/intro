...
void shell_sort_uh( vector<int>::iterator start,  vector<int>::iterator end) 
{
   ...
   int arrSz = 9;
   int arr[] = {1750, 701, 301, 132, 57, 23, 10, 4, 1}; // jumps....  there is a formula
   
   for(unsigned i = 0; i < arrSz; i++)
   {
      insertion_sort1(start, end, arr[i]);
   }
}
//-----------------------------------------------------------------------------------------------------------------------
